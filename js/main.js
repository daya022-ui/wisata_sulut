...
function createBudayaCard(item) {
    return `
        <div class="card fade-in" onclick="scrollToDetails()">
            <img src="img/budaya/${item.image}" alt="${item.title}" class="card-img" onerror="this.src='https://via.placeholder.com/300x250?text=No+Image'">
            <div class="card-body">
